...
export class FavoritesView extends Favorites {
    ...
    createRow() {
        ...
        tr.innerHTML = `
            <td class="user">
                <img src="https://github.com/CristianAlvs.png" alt="imagem do github de Cristian Alves">
                <a href="https://github.com/CristianAlvs" target="_blank">
                    <p>Cristian Alves</p>
                    <span>Cristian Alvs</span>
                </a>
            </td>
